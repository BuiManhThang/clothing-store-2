...
//#region Declare Entities
  ...
  const getPaginationProductInventoryUseCase = new GetProductInventoryPaginationUseCase(productInventoryRepo)
  ...
  export const productInventoryRouter = createProductInventoryRouter(productInventoryController, authMiddleware)
  //#endregion
  ...
  export const receiptDetailRouter = createReceiptDetailRouter(receiptDetailController, authMiddleware)
  //#endregion
...
//#endregion
  ...
  app.use(`${config.app.apiPrefix}/productColors`, productColorRouter)
  app.use(`${config.app.apiPrefix}/productSizes`, productSizeRouter)
  app.use(`${config.app.apiPrefix}/productImages`, productImageRouter)
  ...
  app.use(`${config.app.apiPrefix}/receiptDetails`, receiptDetailRouter)
  app.use(`${config.app.apiPrefix}/orderDetails`, orderDetailRouter)
