...
export class UpdateProductInventoryUseCase {
  ...
  async execute(id: string, updateproductInventoryDTO: UpdateProductInventoryDTO): Promise<ViewProductInventoryDTO | null> {
    ...
    if (updatedProductInventory) return ProductInventoryMapper.toViewProductInventoryDTO(updatedProductInventory)
    return null
  }
}
